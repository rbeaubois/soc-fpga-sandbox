...
"file copy ${dir_viv_prj}/${vivado_prj_name}_dtc/${board}/psu_cortexa53_0/device_tree_domain/bsp/pl.dtsi \
                                   ${dir_viv_prj}/${vivado_prj_name}.dtsi"
"exec bash -c @patch ${dir_viv_prj}/${vivado_prj_name}.dtsi < ${dir_viv_prj}/../../tcl/dtc.patch@"
                    }
                }
                default {
...
"exec bash -c @patch ${dir_viv_prj}/${vivado_prj_name}.dtsi < ${dir_viv_prj}/../../tcl/dtc.patch@"
    ...
    return [string map {@ "\""} [string map {\" ""} [subst $dtc_command]]]
}