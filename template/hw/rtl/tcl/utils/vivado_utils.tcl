namespace eval vivutils {
    ...
    proc create_prj {main_tcl_path board_name vivado_ver prj_name short_prj_name dir_src dir_out strat_synth strat_impl top_file extra_vhdl_std93_files exclude_vhdl_src_files} {
        # Source TCL utilities functions
        source ${main_tcl_path}/utils/futils.tcl

        # Extract board details
        puts "> Extract board details."
        ...
        foreach vhdl_file $extra_vhdl_std93_files {
            # Check if the file exists
            puts "Skipped (default, 93): ${vhdl_file}.vhd"
            if {[file exists [get_files ${vhdl_file}.vhd]]} {
