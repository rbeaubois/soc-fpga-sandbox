# @title    Vivado utilities
# @file		vivado_utils.tcl
...
# 
# @brief Vivado utilities (create project, add files, etc ...)
# 
# @details 
...
namespace eval vivutils {
    ...
    proc generate_static_xsa {nb_jobs vivado_prj_name dir_out} {
        ...
        run_impl ${nb_jobs}
        open_run impl_1
        write_hw_platform -fixed -static -force -file ${dir_out}/${vivado_prj_name}/${vivado_prj_name}.xsa
    }
