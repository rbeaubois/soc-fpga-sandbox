...
\
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_spk/M_AXIS_MM2S] [get_bd_intf_pins bench_dma_aer/S_AXIS_SPK2PL]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_dma_spk/M_AXIS_MM2S] [get_bd_intf_pins ila_axi_debug/SLOT_2_AXIS]
  ...
  connect_bd_intf_net -intf_net bench_dma_aer_M_AXIS_SPK2PS [get_bd_intf_pins axi_dma_spk/S_AXIS_S2MM] [get_bd_intf_pins bench_dma_aer/M_AXIS_SPK2PS]
connect_bd_intf_net -intf_net [get_bd_intf_nets bench_dma_aer_M_AXIS_SPK2PS] [get_bd_intf_pins axi_dma_spk/S_AXIS_S2MM] [get_bd_intf_pins ila_axi_debug/SLOT_3_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets bench_dma_aer_M_AXIS_SPK2PS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps8_0_axi_periph_M03_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins ila_axi_debug/SLOT_0_AXI]
  ...
  connect_bd_net -net dma_spk_free_slots_pl_data_from_ps [get_bd_pins axi_gpio_free_slots_to_pl/data_from_ps] [get_bd_pins bench_dma_aer/dma_spk2pl_fifo_used_slots_ps]
  connect_bd_net -net dma_spk_free_slots_pl_ps_intr [get_bd_pins axi_gpio_free_slots_to_pl/ps_intr] [get_bd_pins bench_dma_aer/dma_spk2pl_fifo_used_slots_ps_intr]
  connect_bd_net -net dma_spk_size_ev_pl_data_from_ps [get_bd_pins axi_gpio_ready_ev_to_ps/data_from_ps] [get_bd_pins bench_dma_aer/dma_spk2ps_fifo_size_rd_ev_ps]
  connect_bd_net -net fan_driver_Dout [get_bd_pins fan_driver/Dout] [get_bd_ports fan_pwm_ctrl]
  connect_bd_net -net rst_clk_wiz_0_199M_peripheral_aresetn [get_bd_pins rst_clk_wiz_0_199M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma_spk/axi_resetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins axi_gpio_free_slots_to_pl/S_AXI_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins axi_gpio_ready_ev_to_ps/S_AXI_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins ila_axi_debug/resetn] [get_bd_pins axi_params_dma/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins bench_dma_aer/S_AXI_LITE_CONTROL_ARESETN] [get_bd_pins bench_dma_aer/S_AXI_LITE_STATUS_ARESETN] [get_bd_pins bench_dma_aer/S_AXIS_SPK2PL_ARESETN] [get_bd_pins bench_dma_aer/M_AXIS_SPK2PS_ARESETN]
  connect_bd_net -net top_0_dma_spk2pl_fifo_free_slots_pl [get_bd_pins bench_dma_aer/dma_spk2pl_fifo_free_slots_pl] [get_bd_pins axi_gpio_free_slots_to_pl/data_to_ps]
  connect_bd_net -net top_0_dma_spk2pl_fifo_free_slots_pl_intr [get_bd_pins bench_dma_aer/dma_spk2pl_fifo_free_slots_pl_intr] [get_bd_pins axi_gpio_free_slots_to_pl/pl_irpt_trigger]
  connect_bd_net -net top_0_dma_spk2ps_fifo_size_wr_ev_pl [get_bd_pins bench_dma_aer/dma_spk2ps_fifo_size_wr_ev_pl] [get_bd_pins axi_gpio_ready_ev_to_ps/data_to_ps]
  connect_bd_net -net top_0_dma_spk2ps_fifo_wr_ev_pl_intr [get_bd_pins bench_dma_aer/dma_spk2ps_fifo_wr_ev_pl_intr] [get_bd_pins axi_gpio_ready_ev_to_ps/pl_irpt_trigger]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_Layers":"/dma_spk_free_slots_pl_ps_intr:true|/dma_spk_size_ev_pl_ps_intr:true|/rst_clk_wiz_0_199M_peripheral_aresetn:true|/zynq_ultra_ps_e_0_pl_resetn0:true|/top_0_dma_spk2ps_fifo_wr_ev_pl_intr:true|/clk_wiz_0_clk_axi:true|/zynq_ultra_ps_e_0_pl_clk0:true|/axi_dma_0_mm2s_introut:true|/axi_dma_0_s2mm_introut:true|/top_0_dma_spk2pl_fifo_free_slots_pl_intr:true|/clk_wiz_0_clk_pl:true|/dma_spk_size_ev_pl_pl_intr:true|/dma_spk_free_slots_pl_pl_intr:true|",
...
preplace netloc top_0_dma_spk2pl_fifo_free_slots_pl 1 3 3 1653 750 2100 820 2840
preplace netloc top_0_dma_spk2pl_fifo_free_slots_pl_intr 1 3 3 1663 20 N 20 2830
preplace netloc top_0_dma_spk2ps_fifo_size_wr_ev_pl 1 3 3 1643 760 2080 830 2830
preplace netloc top_0_dma_spk2ps_fifo_wr_ev_pl_intr 1 3 3 1673 740 2090 840 2820
...
preplace netloc bench_dma_aer_M_AXIS_SPK2PS 1 3 3 1673 70 2170J 180 2820
